...
""" Layer of abstraction representing context that Python code is running in.

	The term 'context' is intended to mean any platform, such as 
	Microsoft-Windows, or any interpreter, such as Jython, or any shell that 
	Python is embedded into, such as iPython/Jupyter. 
...
def sys_exit(code):
    """Swallow the SystemExit exception if it would adversely impact the context."""
    try:
        global __IPYTHON__
        __IPYTHON__
        if code == EX_OK:
